      ...
      <header className="sticky top-0 z-50 border-b border-zinc-300 bg-white">
        <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between gap-6 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-6">
            {/*
              SEARCH SLOT — Partition 4 (feat/encyclopedia-search) mounts
              <SearchBar /> here in the header. Do NOT add search UI in this
              partition; this comment marks the agreed mount point.
            */}
            <Link
              to="/contribute"
