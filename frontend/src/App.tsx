...
export default function App() {
  ...
  const beginInterview = useCallback(() => {
    if (!started.current) {
      started.current = true;
      void trackEvent("form_started", { mode: "interview" });
    }
    setMode("interview");
    setStep("path");
  }, []);
  ...
  const pickType = useCallback(
    (type: SubmissionType) => {
      ...
      setStep(mode === "interview" ? "interview" : "form");
    },
    [mode]
  );
        ...
        return (
          <InterviewChat
            ...
            onDone={(_id, queued) => {
              ...
              void trackEvent("submitted", { mode: "interview" });
              setStep("thankyou");
            }}
            onEscape={() => setStep("form")}
          />
        );
      case "contributor":
        return (
