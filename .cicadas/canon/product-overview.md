...
| **Field View — whiteboard** (`/fieldview`) | Drag players and disc on a scale field; thrower carries the mark; four built-in presets plus user presets (save/rename/delete/export/import); PNG export; keyboard nudge | Shipped — visuals pending client review |
